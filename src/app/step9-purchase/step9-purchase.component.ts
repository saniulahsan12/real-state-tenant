...
@Component({
  selector: 'app-step9-purchase',
  templateUrl: './step9-purchase.component.html',
  styleUrls: ['./step9-purchase.component.css'],
})
export class Step9PurchaseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.step9Form = this.formBuilder.group({
      ...
      foreclosure: ['no', [Validators.required]],
